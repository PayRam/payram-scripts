      ...
      case "$key" in
        ...
        "wallet_connect_id")
          if ! grep -q "configuration_wallet_connect_id_done" "$STATE_FILE"; then
              echo "Configuring wallet_connect_id"
              ...
              echo "Configuration wallet_connect_id already done; skipping."
          fi
          ;;
...
setup_container
  ...
  echo "Script execution finished. Payram server setup completed."
}
